class Security {
    ...
    constructor(){
        ...
        this.access1.style('font-style', 'italic'); 
        this.access1.style('text-align', 'center'); 
        ...
        this.access2.style('font-style', 'italic'); 
        this.access2.style('text-align', 'center'); 
...
//add code for creating and positioning the third input box and button
        ...
        this.access3.style('font-style', 'italic'); 
        this.access3.style('text-align', 'center'); 
